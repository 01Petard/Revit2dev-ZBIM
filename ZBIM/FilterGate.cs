...
namespace ZBIM
{
    ...
    public class FilterGate : IExternalCommand
    {
                    ...
                    if (item_name == pre_item_name)//如果轴网不发生变化，就继续求BoundingXYZ的最大最小XY值
                    {
                        ...
                        if (buildXYZ != null)
                        {
                            ...
                            foreach (var FireGate in FireGateList)
                            {
                                ...
                                {
                                    stringBuilder.AppendLine("item.id：" + item.Id + "，FireGate.LevelId：" + FireGate.LevelId + "，FireGate.Name：" + FireGate.Name + "，FireGate.Id：" + FireGate.Id + "，方位：" + "X:(" + FireGateMinX + "," + FireGateMaxX + ")" + "，Y:(" + FireGateMinY + "," + FireGateMaxY + ")" + "，Z:(" + FireGateMinZ + "," + FireGateMaxZ + ")");
