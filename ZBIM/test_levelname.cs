...
namespace ZBIM
{
    ...
    public class test_level_name : IExternalCommand
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            */
            ...
            foreach (string buildFlag in buildNumList)
            {
                ...
                List<Element> build_levelList = new List<Element>();
                /*
                foreach (Element item in build_upfloorsNumList)
                {
                    //stringBuilder.AppendLine(item.Name);
                }
                */
                ...
                /*
                for (int k = 0; k < build_upfloorsNumList.Count; k++)
                {
                    stringBuilder.AppendLine(build_upfloorsNumList[k].Name);
                }
                */
