...
namespace ZBIM
{
    ...
    public class H00018_v2 : IExternalCommand
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            */
            ...
            foreach (string buildFlag in buildNumList)//从这里开始遍历楼栋
            {
                ...
                List<string> string_filrealarm = new List<string>();
                List<string> string_filrepipe = new List<string>();
                List<string> string_filregate = new List<string>();
                ...
                else if (build_height > 21 && build_height <= 27) //21-27m的建筑，每层判断有无消防立管、消火栓
                {
                    foreach (Level litem in build_upfloorsNumList) //从这里开始遍历建筑的楼层
                    {
                        ...
                        {
                            stringBuilder_pass.AppendLine(temp_level_name + "，有消火栓：" + pass_FireGate + "，有消防立管：" + pass_FirePipe);
                        }
                        else if (exist_FireGate == true && exist_FirePipe == false)
                        {
                            stringBuilder_pass.AppendLine(temp_level_name + "，有消火栓：" + pass_FireGate);
                            stringBuilder_notpass.AppendLine(temp_level_name + "，无消防立管");
                            H00018_pass = false;
                        }
                        else if (exist_FireGate == false && exist_FirePipe == true)
                        {
                            stringBuilder_pass.AppendLine(temp_level_name + "，有消防立管：" + pass_FirePipe);
                            stringBuilder_notpass.AppendLine(temp_level_name + "，无消火栓");
                            H00018_pass = false;
                        }
                        else
                        {
                            stringBuilder_notpass.AppendLine(temp_level_name + "，无消防立管、消火栓");
                            H00018_pass = false;
                        }
                    }
                ...
                else if (build_height > 27) //大于27m的建筑，每层判断有无消火栓箱、消防立管、消火栓
                {
                    foreach (Level litem in build_upfloorsNumList)//从这里开始遍历建筑的楼层
                    {
                        ...
                        if (exist_FireGate == true && exist_FirePipe == true && exist_FireAlarm == true)
                        {
                            stringBuilder_pass.AppendLine(temp_level_name + "，有消火栓：" + pass_FireGate + "有消防立管：" + pass_FirePipe + "有消火栓箱：" + pass_FireAlarm);
                        }
                        else if (exist_FireGate == true && exist_FirePipe == true && exist_FireAlarm == false)
                        {
                            stringBuilder_pass.AppendLine(temp_level_name + "，有消火栓：" + pass_FireGate + "有消防立管：" + pass_FirePipe);
                            stringBuilder_notpass.AppendLine(temp_level_name + "，无消火栓箱");
                            H00018_pass = false;
                        }
                        else if (exist_FireGate == true && exist_FirePipe == false && exist_FireAlarm == true)
                        {
                            stringBuilder_pass.AppendLine(temp_level_name + "，有消火栓：" +  pass_FirePipe + "有消火栓箱：" + pass_FireAlarm);
                            stringBuilder_notpass.AppendLine(temp_level_name + "，无消防立管");
                            H00018_pass = false;
                        }
                        else if (exist_FireGate == false && exist_FirePipe == true && exist_FireAlarm == true)
                        {
                            stringBuilder_pass.AppendLine(temp_level_name + "，有消防立管：" + pass_FirePipe + "有消火栓箱：" + pass_FireAlarm);
                            stringBuilder_notpass.AppendLine(temp_level_name + "，无消火栓");
                            H00018_pass = false;
                        }
                        else if (exist_FireGate == true && exist_FirePipe == false && exist_FireAlarm == false)
                        {
                            stringBuilder_pass.AppendLine(temp_level_name + "，有消火栓：" + pass_FireGate);
                            stringBuilder_notpass.AppendLine(temp_level_name + "，无消防立管、有消火栓箱");
                            H00018_pass = false;
                        }
                        else if (exist_FireGate == false && exist_FirePipe == true && exist_FireAlarm == false)
                        {
                            stringBuilder_pass.AppendLine(temp_level_name + "，有消防立管：" + pass_FirePipe);
                            stringBuilder_notpass.AppendLine(temp_level_name + "，无消火栓、消火栓箱");
                            H00018_pass = false;
                        }
                        else if (exist_FireGate == false && exist_FirePipe == false && exist_FireAlarm == true)
                        {
                            stringBuilder_pass.AppendLine(temp_level_name + pass_FirePipe + "，有消火栓箱：" + pass_FireAlarm);
                            stringBuilder_notpass.AppendLine(temp_level_name + "，无消火栓、消防立管");
                            H00018_pass = false;
                        }
                        else
                        {
                            stringBuilder_notpass.AppendLine(temp_level_name + "，无消防立管、消火栓、消火栓箱");
                            H00018_pass = false;
                        }
